...
for ifq = 1:Nf
    ...
    if cfg.enable_surface_reflection
        ...
        pm_cfg.kstat_random_scatter = cfg.surface_kstat_random_scatter;
        pm_cfg.kstat_seed_offset = cfg.surface_kstat_seed_offset;
        pm_cfg.kstat_conv_padding = cfg.surface_kstat_conv_padding;
        pm_cfg.kstat_trusted_angle_deg = cfg.surface_kstat_trusted_angle_deg;
...
meta = struct( ...
    ...
    'roughness_scale_mode', cfg.surface_roughness_scale_mode, ...
    ...
    'kirchhoff_kstat_meta', local_disabled_kirchhoff_kstat_meta(cfg));
end
...
function meta = local_disabled_kirchhoff_kstat_meta(cfg)
meta = struct( ...
    'enabled', false, ...
    'model', 'off', ...
    'surface_realization_generated', false, ...
    'random_scatter_enabled', false, ...
    'conv_padding', cfg.surface_kstat_conv_padding, ...
    'conv_operator', 'not_executed', ...
    'conv_padding_size', [NaN, NaN], ...
    'conv_crop_start_index', [NaN, NaN], ...
    'conv_crop_end_index', [NaN, NaN], ...
    'conv_crop_rule', 'not_executed', ...
    'trusted_angle_deg', cfg.surface_kstat_trusted_angle_deg, ...
    'Hs_target_m', cfg.sea_hs_target, ...
    'roughness_scale_mode', cfg.surface_roughness_scale_mode, ...
    'sigma_eta_raw_m', NaN, ...
    'Hs_raw_m', NaN, ...
    ...
    'R_coh', complex(NaN, NaN), ...
    'coherent_reflection_formula', 'not_executed', ...
    'S_deltaG', struct('min', NaN, 'max', NaN, 'mean', NaN, 'std', NaN, 'sum', NaN, 'finite_count', 0), ...
    'P_sca', struct('min', NaN, 'max', NaN, 'mean', NaN, 'std', NaN, 'sum', NaN, 'finite_count', 0), ...
    ...
    'reflected_spectrum_stats', local_empty_spectrum_stats(), ...
    'seed_kstat', NaN, ...
    'seed_offset', cfg.surface_kstat_seed_offset, ...
