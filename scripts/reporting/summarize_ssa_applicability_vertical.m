...
ssa2 = local_load_table_if_available( ...
    project_result_file('comparisons', 'compare_ssa1_ssa2_coherent_reflection_vertical_result.mat'), ...
    'summary_table');
padding = local_load_table_if_available( ...
    project_result_file('comparisons', 'compare_ssa_conv_padding_vertical_result.mat'), ...
    'pair_summary_table');
scale_cal = local_load_table_if_available( ...
    project_result_file('experiments', 'calibrate_ssa_scatter_scale_vertical_result.mat'), ...
    'calibration_table');
freq_corr = local_load_table_if_available( ...
    project_result_file('validation', 'validate_ssa_frequency_correlation_vertical_result.mat'), ...
    'summary_table');
