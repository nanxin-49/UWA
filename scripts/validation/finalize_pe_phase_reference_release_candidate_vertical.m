...
files={fullfile('scripts','validation','support','pe_phase_release_run_meta_vertical.m'), ...
    fullfile('scripts','validation','support','assert_pe_phase_release_artifact_vertical.m'), ...
