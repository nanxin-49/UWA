function result = run_bellhop_internal_tilted_wall_poc_vertical(cfg)
%RUN_BELLHOP_INTERNAL_TILTED_WALL_POC_VERTICAL Run the tilted-wall binary.
arguments
    cfg (1,1) struct
end
required={'bellhop_exe','case_root','run_type','wall_r0_m','wall_slope','mapped_receiver_range_m'};
...
fprintf(fid,'%.17g\n%.17g\n%.17g\n',cfg.wall_r0_m,cfg.wall_slope,cfg.mapped_receiver_range_m);
clear cleanup
...
names={'alpha_deg','hit_r','hit_z','line_residual','wall_t_r','wall_t_z','wall_n_r','wall_n_z', ...
