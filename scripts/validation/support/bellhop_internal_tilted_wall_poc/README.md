# Bellhop 2020 tilted straight internal-wall validation overlay

This directory contains the complete modified `bellhop.f90` and `Step.f90`
files used by the validation-only tilted-wall POC. Their unmodified bases are
...
2. straight-wall slope `a` (must be `0.005`), for `r=R0+a*z`;
