...
$OutputDir = Join-Path $projectRoot 'results\validation\bellhop_internal_sinusoidal_wall_poc'
}
...
$validationExe = Join-Path $binDir 'bellhop_iwall_sinusoidal_2020.exe'
...
$manifest = [ordered]@{
    purpose = 'Bellhop 2020 validation-only smooth sinusoidal internal wall POC'
