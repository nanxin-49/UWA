...
tau_ref_signed_s=-(cfg.z_tx+cfg.z_rx)/cfg.c0;
cir=struct();
...
deterministic_f=cache.H_direct_f+cache.H_ref_coh_f;
...
validation.components=struct('H_direct_f',cache.H_direct_f, ...
    'H_ref_coh_f',cache.H_ref_coh_f,'component_sum_max_abs',component_sum_max_abs);
