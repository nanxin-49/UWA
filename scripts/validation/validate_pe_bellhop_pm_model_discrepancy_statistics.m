...
cfg=struct('output_dir',fullfile(root,'results','validation','pe_bellhop_pm_model_discrepancy_statistics'), ...
 ...
 'common_overrides',struct('frequency_hz',4000,'c0_mps',1500,'z_tx_m',100,'z_rx_m',3,'sigma_src_m',.3, ...
  ...
  'domain_half_depth_m',1000,'source_pattern_clip_db',-120,'mapped_receiver_range_m',103,'selector_tolerance_m',1e-4, ...
...
fprintf(fid,'冻结条件：4 kHz、uniform c=1500 m/s、z_tx=100 m、z_rx=3 m、sigma=0.3 m、PM span=160 m、requested Kmax=0.5 rad/m、realized Kmax≈0.471238898 rad/m；PE W=192.1875 m/nx=984/step=0.05 m/sponge off；Bellhop profile N=4097、5001 beams、step=0.05 m、sector ±15°。\n\n');
