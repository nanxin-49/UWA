...
options=struct('code_revision','uncommitted','fixed_geometry',fixed_geometry, ...
...
save(library_file,'library','-v7.3');
...
save(fullfile(out_dir,'conditional_channel_library_u5_u8_smoke.mat'),'result','-v7.3');
