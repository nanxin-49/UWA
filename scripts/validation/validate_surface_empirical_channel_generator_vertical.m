...
candidate_sweep = project_result_file('experiments', 'sweep_monte_carlo_surface_channel_vertical_result.mat');
candidate_fixed = project_result_file('experiments', 'monte_carlo_surface_channel_vertical_result.mat');
if exist(candidate_sweep, 'file')
    result_file = candidate_sweep;
elseif exist(candidate_fixed, 'file')
    result_file = candidate_fixed;
elseif exist('sweep_monte_carlo_surface_channel_vertical_result.mat', 'file')
