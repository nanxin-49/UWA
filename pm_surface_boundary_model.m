...
meta = struct( ...
    ...
    'phase_factor_eff_legacy_note', 'phase_factor_eff is cos_i+cos_s; Kirchhoff phase screen uses 2*k0*xi*phase_factor, while SSA coherent reflection uses k0*phase_factor_eff directly as gamma_i+gamma_s.', ...
